...
/*
Solution: created state for darkMode and added an onClick event with an anonymous function that toggles darkMode state.
          used inline && logical operator to conditionally render darkMode styles
*/
